...
the Monte Carlo grid, interpolation, and coefficient-projection utilities used
to apply the CPTDS conductance framework to an arbitrary user dataset.
"""
...
class ManifoldConfig:
    """Configuration for the generic 3D conductance manifold."""

    n_ions_values: tuple[int, ...] = (48, 64, 80, 96, 112, 136, 160)
    blocker_count_values: tuple[int, ...] = (0, 4, 10, 16, 22, 32, 42)
    blocker_size_values: tuple[float, ...] = (0.005, 0.010, 0.015, 0.020, 0.030, 0.040, 0.060, 0.080, 0.095, 0.110)
...
def quick_manifold_config(grid_trials: int = 4, final_trials: int = 8) -> ManifoldConfig:
    ...
    return ManifoldConfig(
        ...
        blocker_size_values=(0.010, 0.040, 0.080, 0.110),
